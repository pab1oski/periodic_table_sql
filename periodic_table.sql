...
--
-- Name: properties fk_atomic_n; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_atomic_n FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
